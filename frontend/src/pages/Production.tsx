...
const ProductionPage = () => {
    ...
    const fetchInitialData = async () => {
        try {
            const [gadgetRes, empRes] = await Promise.all([
    ...
    return (
        <div className="flex-1 flex flex-col h-screen overflow-hidden relative bg-background-light">
            ...
            <div className="flex-1 p-8 overflow-y-auto">
                {/* Stepper Content */}
                <div className="mx-auto max-w-4xl bg-white/70 backdrop-blur-xl border border-white/50 rounded-[2rem] shadow-2xl flex flex-col overflow-hidden">
